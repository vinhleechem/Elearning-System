...
const CourseContentManagementPage: React.FC = () => {
    ...
    const [lessonsMap, setLessonsMap] = useState<Record<number, LessonResponse[]>>({});
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                console.error(error);
                enqueueSnackbar("Không thể tải nội dung khóa học", { variant: "error" });
            } finally {
                setLoading(false);
            }
        };
    ...
    const handleCreateOrUpdateSection = async () => {
        ...
        try {
            ...
            if (editingSection) {
                ...
                enqueueSnackbar("Cập nhật chương học thành công", { variant: "success" });
            } else {
                ...
                enqueueSnackbar("Thêm chương học mới thành công", { variant: "success" });
            }
        ...
        <Box sx={{ animation: `${fadeIn} 0.5s ease-out`, p: { xs: 2, md: 4 } }}>
            ...
            >
                ...
                <Box display="flex" justifyContent="space-between" alignItems="flex-end" flexWrap="wrap" gap={2}>
                    <Box>
                        <Typography variant="h3" fontWeight={800} sx={{ mb: 1, color: '#334155', letterSpacing: '-0.02em' }}>
                            Nội dung khóa học
                        </Typography>
            ...
            {sections.length === 0 && !loading ? (
                ...
                >
                    <Box sx={{ p: 3, bgcolor: 'white', borderRadius: '50%', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.05)' }}>
                    ...
                    <Box>
                        ...
                        <Typography variant="body1" color="#64748b" maxWidth={500}>
                            Khóa học này chưa có chương nào. Hãy bắt đầu bằng việc tạo chương đầu tiên để xây dựng nội dung cho học viên.
                        </Typography>
                    </Box>
                    <Button
                        variant="outlined"
                        ...
                        >
                            ...
                            >
                                <Box display="flex" gap={3} alignItems="flex-start" width="100%">
                                    {/* Large Number */}
                                    <Typography variant="h4" fontWeight={700} sx={{ color: '#cbd5e1', lineHeight: 1, minWidth: 30 }}>
                                        {section.position}.
                                    </Typography>
                                        ...
                                        <Box display="flex" justifyContent="space-between" alignItems="flex-start">
                                            ...
                                            <Box display="flex" alignItems="center" gap={1}>
                                                ...
                                                <IconButton size="small" sx={{ color: '#64748b' }}>
                                                    {expandedSections[section.sectionId] ? <ExpandLess /> : <ExpandMore />}
                                                </IconButton>
                                            </Box>
                                        </Box>
                                    </Box>
                                            ...
                                            >
                                                <Box display="flex" alignItems="center" gap={2}>
                                                    ...
                                                    <Box sx={{
                                                        ...
                                                        {lesson.type === 'VIDEO' ? <PlayCircleFilledWhite sx={{ color: '#3b82f6' }} /> :
                                                            lesson.type === 'QUIZ' ? <Quiz fontSize="small" /> :
                                                    ...
                                                    <Box>
                                                        ...
                                                        <Typography variant="caption" color="text.secondary" sx={{ fontWeight: 500 }}>
                                                            {lesson.type} • {formatDuration(lesson.durationSeconds)}
                                                        </Typography>
                                                    </Box>
                                                </Box>
                                                ...
                                                <Box display="flex" gap={1}>
                                                    <IconButton
                                                        size="small"
                                                        onClick={() => handleOpenEditLesson(section.sectionId, lesson)}
                                                        sx={{ color: '#cbd5e1', '&:hover': { color: '#3b82f6' } }}
                                                    >
                                                        <EditOutlined fontSize="small" />
                                                    </IconButton>
                                                    <IconButton
                                                        size="small"
                                                        onClick={() => handleDeleteLesson(section.sectionId, lesson.lessonId)}
            ...
            >
                    ...
                    <Stack spacing={3} py={1}>
                        ...
                        <FormControl fullWidth>
                            ...
                            <Select
                                ...
                                onChange={(e) => setLessonForm({ ...lessonForm, isPreview: e.target.value === 'true' })}
                                sx={{ borderRadius: 2 }}
                            >
                        ...
                        {lessonForm.type === "VIDEO" && (
                            ...
                            >
                                <Typography variant="subtitle2" gutterBottom fontWeight={700} color="#334155">
                                    Video bài giảng
                                </Typography>

                                {/* --- Video Preview Player --- */}
                                {videoPreviewUrl && (
                                    <Box mt={1} mb={2} borderRadius={2} overflow="hidden" bgcolor="black" sx={{ aspectRatio: '16/9' }}>
                                        <video
                                            controls
                                            width="100%"
                                            height="100%"
                ...
                <DialogActions sx={{ p: 3, pt: 0 }}>
                    ...
                    <Button
                        ...
                        variant="contained"
                        disabled={!lessonForm.title || (lessonForm.type === 'VIDEO' && !lessonForm.videoAssetId && !editingLesson?.videoUrl)}
                        sx={{ borderRadius: 2, textTransform: 'none', fontWeight: 600, boxShadow: 'none' }}
                    >
                        Lưu bài học
                    </Button>
