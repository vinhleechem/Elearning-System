        ...
        <ul className="flex flex-col gap-1 border-b border-gray-200 pb-3 pt-4">
          <li>
            <DropdownItem
              ...
              tag="a"
              to="/profile"
              className="text-theme-sm group flex items-center gap-3 rounded-lg px-3 py-2 font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700"
            >
              <svg
          ...
          <li>
            <DropdownItem
              ...
              tag="a"
              to="/profile"
              className="text-theme-sm group flex items-center gap-3 rounded-lg px-3 py-2 font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700 dark:hover:bg-white/5 dark:hover:text-gray-300"
            >
              <svg
                className="fill-gray-500 group-hover:fill-gray-700"
                width="24"
