...
export default function MonthlyTarget() {
  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-gray-100">
      <div className="shadow-default rounded-2xl bg-white px-5 pb-11 pt-5 sm:px-6 sm:pt-6">
        <div className="flex justify-between">
          ...
          <div className="relative inline-block">
            <button className="dropdown-toggle" onClick={toggleDropdown}>
              <MoreHoriz className="size-6 text-gray-400 hover:text-gray-700 dark:hover:text-gray-300" />
            </button>
            <Dropdown
              isOpen={isOpen}
        ...
        <div className="relative z-0">
          ...
          <span className="absolute left-1/2 top-full -translate-x-1/2 -translate-y-[95%] rounded-full bg-green-100 px-3 py-1 text-xs font-medium">
            +10%
          </span>
        </div>
      ...
      <div className="flex items-center justify-center gap-5 px-6 py-3.5 sm:gap-8 sm:py-5">
        ...
        <div>
          <p className="text- mb-1 text-center sm:text-sm">Revenue</p>
          <p className="flex items-center justify-center gap-1 text-base font-semibold sm:text-lg">
            $20K
            <svg
              width="16"
