          ...
          <div className="flex w-full flex-col items-center gap-6 xl:flex-row">
            ...
            <div className="order-2 flex grow items-center gap-2 xl:order-3 xl:justify-end">
              <a
                ...
                target="_blank"
                rel="noopener"
                className="shadow-theme-xs flex h-11 w-11 items-center justify-center gap-2 rounded-full border border-gray-300 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-800"
              >
                <svg
